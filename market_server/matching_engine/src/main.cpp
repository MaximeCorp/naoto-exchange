...
int main(int argc, char **argv)
{
    MatchingEngine<MeEpollReceiveBatchSize, MeSkipListMaxLevel, MeFastMapSize,
        ...
        engine(
            argc, argv,
            /*queueSize=*/MeOrderStateQueueSize, // == MeOrderBookUpdateQueueSize;
                                                  // one param currently backs both
            /*skipListNodesPoolSize=*/MeMaxPriceLevels, // one skip list node per
                                                         // resting price level
            ...
            /*nb_fds=*/MaxGateways, // only order gateways connect to a
                                    // matching engine
